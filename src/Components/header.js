...
export default function Header() {
  ...
  return (
    <div className="w-full z-50 flex items-center justify-between bg-th-primary py-2 pr-20 pl-10 sm:pr-28 top-0">
      <Link to="/" id="home">
            ...
            <div className="border-4 border-transparent border-l-teal-600 p-6">
              ...
              <li className="flex justify-around bg-teal-500 p-4 rounded-xl">
                ...
                >
                  <svg
                    title="GitHub"
                    className="h-6 w-6 hover:text-teal-900 text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
